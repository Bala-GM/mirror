...
# Set a more transparent background (alpha = 0.1 for high transparency)
root.attributes('-alpha', 0.1)  # Adjust alpha for higher transparency
...
#pyinstaller --onefile --noconsole --icon=Glass.ico --log-level=DEBUG mirror.py